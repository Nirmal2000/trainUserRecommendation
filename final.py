...
tag_model.save('/content/drive/My Drive/ml_dataset/tag.model')

tag_model = Sentence2Vec('/content/drive/My Drive/ml_dataset/tag.model')
...
title_model.save('/content/drive/My Drive/ml_dataset/title.model')

title_model = Sentence2Vec('/content/drive/My Drive/ml_dataset/title.model')
